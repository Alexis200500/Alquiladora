                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="input-group input-group-outline my-1">
                        ...
                        <input type="text" class="form-control" name="id_estado" value="{{$estado->id_estado}}">                      
                      </div>
                      @if($errors->first('id_estado'))
                        <div class="text-xs text-danger mb-0">{{$errors->first('id_estado')}}</div>                          
                      @endif
                    </div>                    
                    <div class="col-md-6">
                      <div class="input-group input-group-outline my-1">
                      ...
                      @if($errors->first('estado'))
                        <div class="text-xs text-danger mb-0">{{$errors->first('estado')}}</div>                          
                      @endif
                    </div>                    
                  </div>
                  <div class="row">
