          ...
          <div class="col-12">
            <div class="card my-4">
              ...
              <div class="card-body px-0 pb-2">
                <div class="p-4">
                  <form action="{{route('guardar_detalle')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    <div class="col-md-3">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="input-group input-group-outline my-3">
                        ...
                        <input type="text" class="form-control" name="cantidad_personas" value="{{old('cantidad_personas')}}">
                      </div>
